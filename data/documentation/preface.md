...
The first characters and adventures you create will probably be a collection of cliches. That's true of everyone, from the greatest Dungeon Masters in history on down. Accept this reality and move on to create the second character or adventure, which will be betler, and then the third, which will be better still. Repeat that over the course of time, and soon you'll be able to create anything, from a character's background story to an epic world of fantasy adventure.
